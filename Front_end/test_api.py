...
if uploaded_file is not None:
    ...
    with col1:
        st.markdown(f'<p style="background-color:#FFBAAB;color:#972007;border-radius:7px;"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Uploaded noisy audio:<br> <br> </p>', unsafe_allow_html=True) #st.write("Uploaded noisy audio:")
